"""
    DarkFly tools 2022.1
    ------------
 
    Developer/Author    : ABIR (D.N.H.BOYS)
    Supported platform  : all Linux distro and termux(android)
    Company             : DARK NET HACKER BOYS 
    Email               : abirytpk@gmail.com
    YouTube             : Gaming with Mr.A2
    Github              : /mrerroe
    Termux Tested on    : redmi 8
    Linux Tested on     : Ubuntu Gnome 16.04 LTS
 
    ------------
    DarkFly tools 2022.1 is a open source, free, and automatic tools.
"""
